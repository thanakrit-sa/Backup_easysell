    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      <div class="d-flex align-items-center flex-wrap mr-1">
        <div class="d-flex flex-column">
          <h2 class="text-white font-weight-bold my-2 mr-5">Facebook Live</h2>
          <div class="d-flex align-items-center font-weight-bold my-2">
            ...
            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
            <a href="facebook_live.php" class="text-white text-hover-white opacity-75 hover-opacity-100">Facebook Live</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card card-custom gutter-b">
        <div class="card-header">
          <div class="card-title">
            <h4 class="card-label">Live (ใช้กับทุก Pages)</h4>
          </div>
        </div>
        <form class="form">
          <div class="card-body">
