...
export function SubHeader() {
  ...
  return (
    <div id="kt_subheader" align="left" className={` bg-white subheader pt-8 ${layoutProps.subheaderCssClasses}`}>
      <div className={`${layoutProps.subheaderContainerCssClasses} d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap`}>
        ...
        <div className="d-flex align-items-center flex-wrap mr-1">
          ...
          <div className="d-flex align-items-baseline mr-5">
            <div className="row">
              <div className="col">
                <h5 className="text-dark font-weight-bold my-2 mr-5">{subheader.title}</h5>
              </div>
            </div>
            <br/>
            <div className="row">
