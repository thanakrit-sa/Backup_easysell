...
function RegisterFacebook(props) {
    ...
    return (
        <div className="login-form login-signin" style={{ display: "block" }}>
            ...
            <form id="kt_login_signin_form" className="form fv-plugins-bootstrap fv-plugins-framework animated animate__animated animate__backInUp"
...
export default injectIntl(connect(null, auth.actions)(RegisterFacebook));
