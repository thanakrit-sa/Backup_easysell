...
<head>
	<meta charset="utf-8"/>
	<title>EasySell | โปรแกรมแชทบอท Salepage ใช้งานง่าย จัดการออเดอร์ เพิ่มยอดขาย 300%</title>
					...
					<div class="login-signup">
						...
						<form class="form" method="post" id="form-register">
							...
							<div class="form-group d-flex flex-wrap flex-center mt-10">
								...
								<button class="btn btn-light-danger font-weight-bold mx-2">Cancel</button>
							</div>
						</form>
					</div>
				</div>
